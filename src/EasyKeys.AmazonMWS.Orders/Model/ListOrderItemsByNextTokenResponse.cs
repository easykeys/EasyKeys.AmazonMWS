...
namespace EasyKeys.AmazonMWS.Orders.Model
{
    public class ListOrderItemsByNextTokenResponse : AbstractMwsObject, IMWSResponse
    {
        ...
        {
            ListOrderItemsByNextTokenResult = reader.Read<ListOrderItemsByNextTokenResult>("ListOrderItemsByNextTokenResult");
            ResponseMetadata = reader.Read<ResponseMetadata>("ResponseMetadata");
        }

        public override void WriteFragmentTo(IMwsWriter writer)
        {
            writer.Write("ListOrderItemsByNextTokenResult", ListOrderItemsByNextTokenResult);
