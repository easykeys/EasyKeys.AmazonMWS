...
namespace EasyKeys.AmazonMWS.Runtime
{
    ...
    public class MwsResponseHeaderMetadata
    {
        ...
        private readonly List<string> _responseContext;
        private readonly string _timestamp;

        private double? _quotaMax;
        private double? _quotaRemaining;
        private DateTime? _quotaResetsAt;
        ...
        public string ResponseContext => string.Join(", ", _responseContext.ToArray());
        ...
        /// </summary>
        public DateTime? QuotaResetsAt => _quotaResetsAt;
