...
namespace MarketplaceWebService.Model
{
    ...
    public class GetReportListRequest
    {
        ...
        {
            get { return _maxCountField.GetValueOrDefault(); }
        ...
        {
            return _maxCountField.HasValue;
        }
        ...
        /// <returns>this instance.</returns>
        public GetReportListRequest WithAcknowledged(bool acknowledged)
        {
        ...
        public bool IsSetReportRequestIdList()
        {
            return ReportRequestIdList != null;
        }
    }
}
