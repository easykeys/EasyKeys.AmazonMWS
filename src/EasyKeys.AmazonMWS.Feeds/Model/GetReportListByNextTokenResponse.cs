...
namespace MarketplaceWebService.Model
{
    ...
    public class GetReportListByNextTokenResponse
    {
        ...
        {
            GetReportListByNextTokenResult = getReportListByNextTokenResult;
            return this;
        }
        ...
        public bool IsSetGetReportListByNextTokenResult()
        {
            return GetReportListByNextTokenResult != null;
        }
        ...
        public string ToXML()
        {
            ...
            {
                GetReportListByNextTokenResult getReportListByNextTokenResult = GetReportListByNextTokenResult;
