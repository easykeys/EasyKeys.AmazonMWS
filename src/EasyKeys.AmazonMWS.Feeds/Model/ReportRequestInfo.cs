...
namespace MarketplaceWebService.Model
{
    ...
    public class ReportRequestInfo
    {
        ...
        private string _generatedReportIdField;
        ...
        {
            get { return _submittedDateField.GetValueOrDefault(); }
        ...
        {
            get { return _generatedReportIdField; }
            set { _generatedReportIdField = value; }
        }
        ...
        /// <param name="generatedReportId"></param>
        /// <returns>this instance.</returns>
        public ReportRequestInfo WithGeneratedReportId(string generatedReportId)
        {
            _generatedReportIdField = generatedReportId;
            return this;
        }
        ...
        {
            return _generatedReportIdField != null;
        }
        ...
        {
            get { return _completedDateField.GetValueOrDefault(); }
