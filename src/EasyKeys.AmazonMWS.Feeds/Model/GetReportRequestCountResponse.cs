...
namespace MarketplaceWebService.Model
{
    ...
    public class GetReportRequestCountResponse
    {
        ...
        {
            GetReportRequestCountResult = getReportRequestCountResult;
            return this;
        }
        ...
        public bool IsSetGetReportRequestCountResult()
        {
            return GetReportRequestCountResult != null;
        }
        ...
        public string ToXML()
        {
            ...
            {
                GetReportRequestCountResult getReportRequestCountResult = GetReportRequestCountResult;
