...
namespace MarketplaceWebService.Model
{
    ...
    public class GetReportListResponse
    {
        ...
        {
            GetReportListResult = getReportListResult;
            return this;
        }
        ...
        public bool IsSetGetReportListResult()
        {
            return GetReportListResult != null;
        }
        ...
        public string ToXML()
        {
            ...
            {
                GetReportListResult getReportListResult = GetReportListResult;
