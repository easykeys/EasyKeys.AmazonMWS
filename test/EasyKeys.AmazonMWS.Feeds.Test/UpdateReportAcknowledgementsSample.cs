...
namespace EasyKeys.AmazonMWS.Feeds.Test
{
    ...
    public class UpdateReportAcknowledgementsSample
    {
        ...
        public static async Task InvokeUpdateReportAcknowledgements(IMarketplaceWebService service, UpdateReportAcknowledgementsRequest request)
        {
            try
            {
                var response = await service.UpdateReportAcknowledgements(request);
                ...
                if (response.IsSetUpdateReportAcknowledgementsResult())
                {
                    ...
                    var reportInfoList = updateReportAcknowledgementsResult.ReportInfo;
