...
namespace EasyKeys.AmazonMWS.Feeds.Test
{
    ...
    public class GetFeedSubmissionResultSample
    {
        ...
        public static async Task InvokeGetFeedSubmissionResult(IMarketplaceWebService service, GetFeedSubmissionResultRequest request)
        {
            try
            {
                var response = await service.GetFeedSubmissionResult(request);
                ...
                if (response.IsSetGetFeedSubmissionResultResult())
                {
                    ...
                    var getFeedSubmissionResultResult = response.GetFeedSubmissionResultResult;
