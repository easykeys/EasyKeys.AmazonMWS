...
namespace EasyKeys.AmazonMWS.Feeds.Test
{
    ...
    public class GetReportCountSample
    {
        ...
        public static async Task InvokeGetReportCount(IMarketplaceWebService service, GetReportCountRequest request)
        {
            try
            {
                var response = await service.GetReportCount(request);
                ...
                if (response.IsSetGetReportCountResult())
                {
                    ...
                    var getReportCountResult = response.GetReportCountResult;
