...
namespace EasyKeys.AmazonMWS.Feeds.Test
{
    ...
    public class GetReportScheduleListByNextTokenSample
    {
        ...
        public static async Task InvokeGetReportScheduleListByNextToken(IMarketplaceWebService service, GetReportScheduleListByNextTokenRequest request)
        {
            try
            {
                var response = await service.GetReportScheduleListByNextToken(request);
                ...
                if (response.IsSetGetReportScheduleListByNextTokenResult())
                {
                    ...
                    var getReportScheduleListByNextTokenResult = response.GetReportScheduleListByNextTokenResult;
                    ...
                    var reportScheduleList = getReportScheduleListByNextTokenResult.ReportSchedule;
