...
namespace EasyKeys.AmazonMWS.Feeds.Test
{
    ...
    public class SubmitFeedSample
    {
        ...
        public static async Task InvokeSubmitFeed(IMarketplaceWebService service, SubmitFeedRequest request)
        {
            try
            {
                var response = await service.SubmitFeed(request);
                ...
                if (response.IsSetSubmitFeedResult())
                {
                    ...
                    if (submitFeedResult.IsSetFeedSubmissionInfo())
                    {
                        ...
                        var feedSubmissionInfo = submitFeedResult.FeedSubmissionInfo;
