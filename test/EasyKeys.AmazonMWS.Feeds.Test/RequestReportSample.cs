...
namespace EasyKeys.AmazonMWS.Feeds.Test
{
    ...
    public class RequestReportSample
    {
        ...
        public static async Task InvokeRequestReport(IMarketplaceWebService service, RequestReportRequest request)
        {
            try
            {
                var response = await service.RequestReport(request);
                ...
                if (response.IsSetRequestReportResult())
                {
                    ...
                    var requestReportResult = response.RequestReportResult;
                    var reportRequestInfo = requestReportResult.ReportRequestInfo;
