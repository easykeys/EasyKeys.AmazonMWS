...
namespace EasyKeys.AmazonMWS.Feeds.Test
{
    ...
    public class GetReportScheduleListSample
    {
        ...
        public static async Task InvokeGetReportScheduleList(IMarketplaceWebService service, GetReportScheduleListRequest request)
        {
            try
            {
                var response = await service.GetReportScheduleList(request);
                ...
                if (response.IsSetGetReportScheduleListResult())
                {
                    ...
                    var getReportScheduleListResult = response.GetReportScheduleListResult;
                    ...
                    var reportScheduleList = getReportScheduleListResult.ReportSchedule;
