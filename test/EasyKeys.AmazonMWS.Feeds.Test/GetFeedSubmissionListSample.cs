...
namespace EasyKeys.AmazonMWS.Feeds.Test
{
    ...
    public class GetFeedSubmissionListSample
    {
        ...
        public static async Task InvokeGetFeedSubmissionList(IMarketplaceWebService service, GetFeedSubmissionListRequest request)
        {
            try
            {
                var response = await service.GetFeedSubmissionList(request);
                ...
                if (response.IsSetGetFeedSubmissionListResult())
                {
                    ...
                    var getFeedSubmissionListResult = response.GetFeedSubmissionListResult;
                    ...
                    var feedSubmissionInfoList = getFeedSubmissionListResult.FeedSubmissionInfo;
