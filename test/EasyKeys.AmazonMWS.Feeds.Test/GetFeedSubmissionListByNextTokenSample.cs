...
namespace EasyKeys.AmazonMWS.Feeds.Test
{
    ...
    public class GetFeedSubmissionListByNextTokenSample
    {
        ...
        public static async Task InvokeGetFeedSubmissionListByNextToken(IMarketplaceWebService service, GetFeedSubmissionListByNextTokenRequest request)
        {
            try
            {
                var response = await service.GetFeedSubmissionListByNextToken(request);
                ...
                if (response.IsSetGetFeedSubmissionListByNextTokenResult())
                {
                    ...
                    var getFeedSubmissionListByNextTokenResult = response.GetFeedSubmissionListByNextTokenResult;
                    ...
                    var feedSubmissionInfoList = getFeedSubmissionListByNextTokenResult.FeedSubmissionInfo;
