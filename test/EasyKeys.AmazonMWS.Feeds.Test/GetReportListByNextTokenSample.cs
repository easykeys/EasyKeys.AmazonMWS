...
namespace EasyKeys.AmazonMWS.Feeds.Test
{
    ...
    public class GetReportListByNextTokenSample
    {
        ...
        public static async Task InvokeGetReportListByNextToken(IMarketplaceWebService service, GetReportListByNextTokenRequest request)
        {
            try
            {
                var response = await service.GetReportListByNextToken(request);
                ...
                if (response.IsSetGetReportListByNextTokenResult())
                {
                    ...
                    var getReportListByNextTokenResult = response.GetReportListByNextTokenResult;
                    ...
                    var reportInfoList = getReportListByNextTokenResult.ReportInfo;
