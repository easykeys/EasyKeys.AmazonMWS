...
namespace EasyKeys.AmazonMWS.Feeds.Test
{
    ...
    public class GetReportRequestCountSample
    {
        ...
        public static async Task InvokeGetReportRequestCount(IMarketplaceWebService service, GetReportRequestCountRequest request)
        {
            try
            {
                var response = await service.GetReportRequestCount(request);
                ...
                if (response.IsSetGetReportRequestCountResult())
                {
                    ...
                    var getReportRequestCountResult = response.GetReportRequestCountResult;
