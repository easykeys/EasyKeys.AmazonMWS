...
namespace EasyKeys.AmazonMWS.Feeds.Test
{
    ...
    public class CancelReportRequestsSample
    {
        ...
        public static async Task InvokeCancelReportRequests(IMarketplaceWebService service, CancelReportRequestsRequest request)
        {
            try
            {
                var response = await service.CancelReportRequests(request);
                ...
                if (response.IsSetCancelReportRequestsResult())
                {
                    ...
                    var cancelReportRequestsResult = response.CancelReportRequestsResult;
                    var reportRequestInfoList = cancelReportRequestsResult.ReportRequestInfo;
