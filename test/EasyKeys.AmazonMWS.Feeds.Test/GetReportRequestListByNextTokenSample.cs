...
namespace EasyKeys.AmazonMWS.Feeds.Test
{
    ...
    public class GetReportRequestListByNextTokenSample
    {
        ...
        public static async Task InvokeGetReportRequestListByNextToken(IMarketplaceWebService service, GetReportRequestListByNextTokenRequest request)
        {
            try
            {
                var response = await service.GetReportRequestListByNextToken(request);
                ...
                if (response.IsSetGetReportRequestListByNextTokenResult())
                {
                    ...
                    var getReportRequestListByNextTokenResult = response.GetReportRequestListByNextTokenResult;
                    ...
                    var reportRequestInfoList = getReportRequestListByNextTokenResult.ReportRequestInfo;
