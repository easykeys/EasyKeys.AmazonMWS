...
namespace EasyKeys.AmazonMWS.Feeds.Test
{
    ...
    public class CancelFeedSubmissionsSample
    {
        ...
        public static async Task InvokeCancelFeedSubmissions(IMarketplaceWebService service, CancelFeedSubmissionsRequest request)
        {
            try
            {
                var response = await service.CancelFeedSubmissions(request);
                ...
                if (response.IsSetCancelFeedSubmissionsResult())
                {
                    ...
                    var cancelFeedSubmissionsResult = response.CancelFeedSubmissionsResult;
                    ...
                    var feedSubmissionInfoList = cancelFeedSubmissionsResult.FeedSubmissionInfo;
