...
namespace EasyKeys.AmazonMWS.Feeds.Test
{
    ...
    public class ManageReportScheduleSample
    {
        ...
        public static async Task InvokeManageReportSchedule(IMarketplaceWebService service, ManageReportScheduleRequest request)
        {
            try
            {
                var response = await service.ManageReportSchedule(request);
                ...
                if (response.IsSetManageReportScheduleResult())
                {
                    ...
                    var manageReportScheduleResult = response.ManageReportScheduleResult;
                    ...
                    var reportScheduleList = manageReportScheduleResult.ReportSchedule;
